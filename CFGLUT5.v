...
`ifdef GLITCH_IQ
    // Clock
    input  wire CLK /* verilator public_flat_rd */,
    // Clock enable
    input  wire CE /* verilator public_flat_rd */,
    // LUT inputs
    input  wire I0 /* verilator public_flat_rd */, I1 /* verilator public_flat_rd */, I2 /* verilator public_flat_rd */, I3 /* verilator public_flat_rd */, I4 /* verilator public_flat_rd */,
    // LUT configuration data input
    input  wire CDI /* verilator public_flat_rd */,
`else
    input  wire CLK,
    input  wire CE,
